    ...
    <div className='header'>
        ...
        <div className="header-nav">
            ...
            <span className='ind'>IND</span>
             <select className='cntry-dropdown'>
               ...
               {/* <div> <img className='india' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlHeJVLkSfDJA3a1xX97Ov0SI0MDn_u901fw&usqp=CAU" alt="jhgf" /> </div> */}
                {/* <option className='contry' value=""> You are shopping on Amazon.in</option> */}
            </select> 
        </div>
